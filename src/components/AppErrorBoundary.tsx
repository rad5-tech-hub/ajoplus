		...
		<div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
			<div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
				...
				<div className="space-y-3">
					<button
						onClick={onReset}
						className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand-600 text-white rounded-2xl font-medium hover:bg-brand-700 transition-colors active:scale-95 cursor-pointer"
					>
					...
					<button
						...
						className="w-full px-4 py-3 bg-slate-200 text-brand-900 rounded-2xl font-medium hover:bg-slate-300 transition-colors active:scale-95 cursor-pointer"
					>
						Go Home
					</button>
				</div>
