    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 text-slate-600 hover:text-brand-900 transition-colors w-fit"
          >
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="font-semibold text-base sm:text-lg text-brand-900 leading-tight mb-1">
                      {item.title}
                    </h3>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-4">
                        <div className="text-right">
                          <div className="font-bold text-brand-600 text-lg sm:text-xl">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:sticky lg:top-24 shadow-sm">
              ...
              <div className="border-t border-brand-200 pt-5 sm:pt-6 mb-6 sm:mb-8">
              ...
              <button
                ...
                className="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-4 rounded-2xl flex items-center justify-center gap-2 transition-colors mb-4"
              >
                Proceed to Checkout →
              </button>

              <div className="bg-brand-50 border border-brand-100 rounded-2xl p-4 sm:p-5 text-sm text-amber-800 mb-4 sm:mb-6">
                <strong>Note:</strong> You'll need to sign up or log in to complete your purchase.
              </div>

              <button
                onClick={() => navigate('/browse')}
                className="w-full border-2 border-brand-600 text-brand-600 font-semibold py-4 rounded-2xl hover:bg-brand-50 transition-colors"
              >
                Continue Shopping
              </button>
            </div>
