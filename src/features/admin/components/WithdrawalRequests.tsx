    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div ref={ref} className="bg-white rounded-3xl w-full max-w-md shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-3.5">
          ...
          <h2 className="text-base font-semibold text-slate-900">Reject Withdrawal</h2>
          <div className="w-8" />
        </div>
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:outline-none focus:border-red-400 h-24 resize-none text-sm leading-relaxed"
              autoFocus
            />
          </div>
    ...
    <>
      <div className="flex items-start justify-between mb-1 sm:mb-2">
        ...
        <button
          onClick={() => refetch()}
          disabled={isFetching}
          className="p-2.5 rounded-2xl border border-slate-200 text-slate-500 hover:bg-slate-50 transition-colors disabled:opacity-50"
        >
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 sm:gap-4 min-w-0 sm:flex-1">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 text-lg">
                    👤
                  </div>
                    ...
                    {w.status === 'pending' ? (
                      <>
                        <button
                          ...
                          className="bg-emerald-600 hover:bg-emerald-700 active:scale-95 transition-all text-white px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl flex items-center gap-1.5 text-sm font-medium disabled:opacity-60 disabled:cursor-not-allowed whitespace-nowrap"
                        >
