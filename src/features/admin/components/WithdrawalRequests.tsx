...
const WithdrawalRequests = () => {
  ...
  const [sectionTab, setSectionTab] = useState<'customer' | 'agent'>('customer');
  ...
  return (
    <>
      {/* Section toggle — Customer / Agent */}
      <div className="flex gap-2 mb-6">
        <button onClick={() => setSectionTab('customer')}
        ...
        <button onClick={() => setSectionTab('agent')}
          className={`px-5 py-2 rounded-full text-sm font-semibold transition-all duration-200 cursor-pointer ${
            sectionTab === 'agent'
              ? 'bg-amber-600 text-white border-amber-600'
              : 'bg-white border border-amber-200 text-slate-600 hover:bg-amber-50'
