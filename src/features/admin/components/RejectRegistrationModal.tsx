    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl w-full max-w-md mx-auto shadow-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-slate-900">Reject Registration Fee</h3>
        ...
        <textarea
          ...
          disabled={isPending}
          className="w-full px-4 py-3 border border-slate-200 focus:border-red-400 rounded-2xl focus:outline-none h-28 resize-none text-sm disabled:opacity-50"
        />
