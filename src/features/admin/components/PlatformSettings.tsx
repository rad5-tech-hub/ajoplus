		...
		<div className="space-y-4 sm:space-y-6 lg:space-y-8">
			...
			<div className="bg-white border border-slate-100 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
				<div className="flex items-center gap-3 mb-5 sm:mb-6">
					<div className="w-8 h-8 bg-brand-100 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 text-base">
						⚙️
					</div>
					<h3 className="text-xl sm:text-2xl font-semibold text-brand-900">Ajo Commission Rate</h3>
				</div>
				...
				<div className="flex items-center gap-4 sm:gap-8 mb-5 sm:mb-6">
					<input
						...
						className="flex-1 accent-brand-600 h-2 disabled:opacity-50"
					/>
					<span className="text-3xl sm:text-4xl font-bold text-brand-600 shrink-0 w-16 text-right">
				...
				<button
					...
					disabled={updatePending}
					className="mt-6 sm:mt-8 cursor-pointer bg-brand-600 hover:bg-brand-700 disabled:opacity-50 active:scale-95 transition-all text-white px-6 sm:px-10 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base w-full sm:w-auto flex items-center justify-center gap-2"
				>
					{updatePending ? (
						<>
