  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-brand-900">Savings Plans</h2>
      ...
      {isError && !isLoading && (
        <div className="rounded-3xl bg-white border border-red-200 p-6 text-center">
          ...
          <button
            onClick={() => refetch()}
            className="px-5 py-2 rounded-2xl bg-brand-600 text-white text-sm font-semibold hover:bg-brand-700 transition-colors"
          >
            Retry
          </button>
        </div>
