...
const SavingsCard = memo(({ plan, onWithdraw }: SavingsCardProps) => {
  ...
  return (
    <div className="bg-amber-600 text-white rounded-3xl p-5 w-full shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-white/20 rounded-xl flex items-center justify-center">
            <PiggyBank className="w-4 h-4 text-white" />
          </div>
          <p className="text-amber-200 text-xs font-medium truncate max-w-[180px]">{plan.name}</p>
        </div>
      ...
      <div className="bg-white/10 border border-white/20 py-3 px-4 rounded-2xl mb-3">
        <div className="space-y-2.5">
          ...
          <div className="flex justify-between items-center">
            <p className="text-amber-100 text-xs">Commission (5%)</p>
      ...
      <div className="bg-white/10 border border-white/20 py-3 px-4 rounded-2xl mb-4">
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <p className="text-amber-100 text-xs">Days saved</p>
            <p className="text-sm font-medium text-white">{plan.daysSaved} days</p>
          </div>
          <div className="flex justify-between items-center">
            <p className="text-amber-100 text-xs">Next commission</p>
