  ...
  return (
    <div className="bg-white border border-slate-300 shadow-lg rounded-3xl p-6">
      ...
      <div className="space-y-3">
        <button className="w-full cursor-pointer bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-4 rounded-2xl transition-all active:scale-[0.985]">
          Make Payment
        </button>
        
        <button className="w-full cursor-pointer border border-emerald-600 text-emerald-600 font-semibold py-4 rounded-2xl hover:bg-emerald-50 transition-all">
          Browse Packages
        </button>
