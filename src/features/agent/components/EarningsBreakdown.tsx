...
const EarningsBreakdown = () => {
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
      <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-brand-900 mb-6">
        Earnings Breakdown
      </h3>
      ...
      <button
        ...
        className="w-full mt-10 bg-brand-600 hover:bg-brand-700 active:scale-[0.985] disabled:opacity-50 disabled:pointer-events-none text-white font-semibold py-4 rounded-2xl text-base transition-all"
      >
        Request Withdrawal
      </button>
