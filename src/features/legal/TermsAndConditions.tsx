    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors text-sm mb-4"
          >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        {/* Contact */}
        <div className="bg-emerald-50 border border-emerald-100 rounded-3xl p-6 sm:p-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-3 rounded-2xl text-sm transition-all active:scale-[0.985]"
          >
            Contact Support
          </a>
        </div>
